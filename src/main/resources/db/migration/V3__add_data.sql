...
insert into message(id, message_text, date_time_of_creation, status, client_id, notification_id)
    values
        (1, 'Летняя распродажа, поторопись!', '2022-04-18T14:05:23', 'delivery', 1, 1),
        (2, 'Летняя распродажа, поторопись!', '2022-04-18T14:06:56', 'delivery', 9, 1),
        (3, 'Зимняя распродажа, поторопись! Для оленей скидки.', '2022-04-18T14:05:23', 'delivery', 6, 2),
        (4, 'Зимняя распродажа, поторопись! Для оленей скидки.', '2022-04-18T14:05:23', 'delivery', 7, 2),
        (5, 'Зимняя распродажа, поторопись! Для оленей скидки.', '2022-04-18T14:05:23', 'delivery', 8, 2);